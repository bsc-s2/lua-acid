...
function test.parse(t)
    ...
    for fmtkey, date, expected, err_code, desc in t:case_iter(4, {
        ...
        {'ngxaccesslog', '26/Jul/2017:14:13:17',          1501049597, nil           },
        {'ngxerrorlog',  '2017/07/26 14:13:17',           1501049597, nil           },
        ...
        {'ngxaccesslog', '26/Jux/2017:14:13:17',          nil,        'FormatError' },
...
function test.format(t)
    ...
    for fmtkey, ts, expected, err_code, desc in t:case_iter(4, {
        ...
        {'ngxaccesslog', 1501049597, '26/Jul/2017:14:13:17',          nil             },
        {'ngxerrorlog',  1501049597, '2017/07/26 14:13:17',           nil             },
